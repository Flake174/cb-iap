 ...
 * 1. Provides a new API to get details of in-app items published for the app
 * including
 * price, type, title and description.
 * 2. The purchase flow is synchronous and purchase information is available
 * immediately
 * after it completes.
 * 3. Purchase information of in-app purchases is maintained within the Google
 * Play system
 * till the purchase is consumed.
 * 4. An API to consume a purchase of an inapp item. All purchases of one-time
 * in-app items are consumable and thereafter can be purchased again.
 * 5. An API to get current purchases of the user immediately. This will not
 * contain any
 * consumed purchases.
 *
 ...
 * RESULT_ITEM_ALREADY_OWNED = 7 - Failure to purchase since item is already
 * owned
...
public interface IInAppBillingService extends android.os.IInterface {
     ...
     public static abstract class Stub extends android.os.Binder
          ...
          private static class Proxy implements com.android.vending.billing.IInAppBillingService {
                ...
                * with a list JSON strings containing the productId, price, title and
                * description.
                ...
                *         "title : "Example Title", "description" : "This is an example
                *         description" }'
                */
               @Override
               public android.os.Bundle getSkuDetails(int apiVersion, java.lang.String packageName,
                         java.lang.String type, android.os.Bundle skusBundle) throws android.os.RemoteException {
                    android.os.Parcel _data = android.os.Parcel.obtain();
                    android.os.Parcel _reply = android.os.Parcel.obtain();
               ...
               /**
                * Returns a pending intent to launch the purchase flow for an in-app item by
                * providing a SKU,
                ...
                *                         purchases
                *                         and "subs" for subscription).
                * @param developerPayload optional argument to be sent back with the purchase
                *                         information
                * @return Bundle containing the following key-value pairs
                *         "RESPONSE_CODE" with int value, RESULT_OK(0) if success, other
                *         response codes on
                ...
                *         startIntentSenderForResult. When purchase flow
                *         has completed, the onActivityResult() will give a resultCode of OK or
                *         CANCELED.
                *         If the purchase is successful, the result data will contain the
                ...
                *         "INAPP_DATA_SIGNATURE" - String containing the signature of the
                *         purchase data that
                ...
                * This will return all SKUs that have been purchased in V3 and managed items
                * purchased using
                ...
                *                          ("inapp" for one-time purchases and "subs" for
                *                          subscription).
                * @param continuationToken to be set as null for the first call, if the number
                *                          of owned
                *                          skus are too many, a continuationToken is returned
                *                          in the response bundle.
                *                          This method can be called again with the
                *                          continuation token to get the next set of
                *                          owned skus.
                * @return Bundle containing the following key-value pairs
                *         "RESPONSE_CODE" with int value, RESULT_OK(0) if success, other
                *         response codes on
                *         failure as listed above.
                *         "INAPP_PURCHASE_ITEM_LIST" - StringArrayList containing the list of
                *         SKUs
                *         "INAPP_PURCHASE_DATA_LIST" - StringArrayList containing the purchase
                *         information
                *         "INAPP_DATA_SIGNATURE_LIST"- StringArrayList containing the
                *         signatures
                *         of the purchase information
                *         "INAPP_CONTINUATION_TOKEN" - String containing a continuation token
                *         for the
                *         next set of in-app purchases. Only set if the
                *         user has more owned skus than the current list.
                */
               @Override
               public android.os.Bundle getPurchases(int apiVersion, java.lang.String packageName,
                         java.lang.String type, java.lang.String continuationToken) throws android.os.RemoteException {
                    android.os.Parcel _data = android.os.Parcel.obtain();
                    android.os.Parcel _reply = android.os.Parcel.obtain();
                    android.os.Bundle _result;
                    try {
                ...
                * being removed
                * from all subsequent responses to getPurchases() and allow re-purchase of this
                * item.
                * 
                * @param apiVersion    billing API version that the app is using
                * @param packageName   package name of the calling app
                * @param purchaseToken token in the purchase information JSON that identifies
                *                      the purchase
                *                      to be consumed
                * @return 0 if consumption succeeded. Appropriate error values for failures.
                */
               @Override
               public int consumePurchase(int apiVersion, java.lang.String packageName, java.lang.String purchaseToken)
                         throws android.os.RemoteException {
                    android.os.Parcel _data = android.os.Parcel.obtain();
                    android.os.Parcel _reply = android.os.Parcel.obtain();
                    int _result;
